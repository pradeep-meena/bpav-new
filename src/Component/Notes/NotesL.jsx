...
const NotesL = () => {
  ...
  <option value="1">Delete Marked</option>
  <option value="2">Unmark All</option>
  <option value="3">Mark All</option>
</select>
                    </div>
                  ...
                  <div className="btn btn-primary me-2" style={{ background: '#ffffff'}}  >
                  <Link to="/noteslist">
                  <i class="fa fa-list" ></i>
                    </Link>
                    <button className="btn btn-primary ms-2" onClick={handleNewNote} >Add Note</button>
                  </div>
  ...
  <option value="2">Last Modified By Me</option>
