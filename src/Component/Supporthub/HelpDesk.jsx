          ...
          <tbody>
            {products.map((product) => (
              <tr key={product.id}>
                ...
                {/* <Link to= "/support/ticketcard"> */}
                  <td onClick={() => navigate("/support/ticketcard")}>{product.channel}</td> 
                {/* </Link> */}
                {/* <Link to= "/support/ticketcard"> */}
                <td onClick={() => navigate('/support/ticketcard')}>{product.ticketName}</td>
                {/* </Link> */}
                <td  onClick={() => navigate('/support/ticketcard') }>{product.contact}</td>
                <td onClick={() => navigate('/support/ticketcard') }>{product.company}</td>
              </tr>
            ))}
          </tbody>
        </table>
...
export const Sidebar = () => {
  return (
    <div className="d-flex flex-column bg-light vh-100 py-3" style={{
      overflowY: 'auto',
      ...
      <ul className="nav flex-column" style={{ listStyleType: 'none', paddingLeft: '0' }}>
        <li className="nav-item mb-1" style={{ fontSize: '0.9rem' }}>
          <Link to='/support/summaryview' className="nav-link text-dark d-flex justify-content-between align-items-center" aria-label="Summary">
        ...
        <li className="nav-item mb-1" style={{ fontSize: '0.9rem' }}>
          <Link to='/support/analytics' className="nav-link text-dark d-flex justify-content-between align-items-center" aria-label="Analyze">
            <div className="d-flex align-items-center">
...
const HelpDesk = () => {
  return (
        ...
        <div className="container-fluid d-flex flex-column border border-dark-300">
          <TableHeader />
          <TicketTable />
